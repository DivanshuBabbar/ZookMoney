...
<title>{{ general_setting('site_name') }} Sign In</title>
<!-- Favicon-->
                ...
                <div class="col-lg-5 col-md-12 offset-lg-1">
                    ...
                    <div class="card-plain">
                        <div class="header">
                          ...
                          <div class="company_detail">
                        <h4 class="logo"><img src="{{$user->avatar()}}" height="62" alt="{{ general_setting('site_name') }}"> <span class="m-l-10">{{ general_setting('site_name') }}</span></h4>
                        <h3>@ {{$user->name}}</h3>
