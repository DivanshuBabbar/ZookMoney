        ...
        <div class="col-lg-9 col-md-12">
          <div class="row">
            <div class="col"  id="#sendMoney">
              ...
              <div class="card">
                <div class="header">
                    <h2><strong>{{__('Money')}}</strong> {{__('Transfer To Users & Merchants')}}</h2>
                        ...
                        <div class="row">
                          <div class="col">
                            <div class="form-group {{ $errors->has('description') ? ' has-danger' : '' }}">
                              ...
                              <textarea class="form-control" rows="5" id="description" name="description" placeholder="{{__('Write a note...')}}" required>{{old('description')}}</textarea>
