        ...
        <div class="row justify-content-md-center">
              <div class="row">
                                                        ...
                                                        <?php
                                                            ...
                                                            $userDetails = [
                                                                'amounts' => [ // at least one currency amount is required
                                                                    'USD'   => \App\Helpers\Money::instance()->value($total_amount),
                                                                    'INR'   => \App\Helpers\Money::instance()->value($total_amount),
                                                                    'NGN'   => \App\Helpers\Money::instance()->value($total_amount),
                                                                    'TRY'   => \App\Helpers\Money::instance()->value($total_amount),
                                                                    'EUR'   => \App\Helpers\Money::instance()->value($total_amount),
                                                                    'BRL'   => \App\Helpers\Money::instance()->value($total_amount)
                                                                ],
                ...
                <script type="text/javascript">
                    ...
                    $('body').on('change','input[name=paymentOption]',function(){
                        ...
                        $('#lwPaymentForm').on('submit', function(e) {
                            ...
                            if (paymentOption == 'paypal' || paymentOption == 'paytm' || paymentOption == 'instamojo' || paymentOption == 'iyzico' || paymentOption == 'authorize-net' || paymentOption == 'bitpay' || paymentOption == 'mercadopago' || paymentOption == 'payumoney' || paymentOption == 'mollie' || paymentOption == 'pagseguro' || paymentOption == 'strowallet') {
                                ...
                                $.ajax({
                                    ...
                                    context: this,
                                    url: '{{url("/merchant_gatepay_process_payment")}}', // post data url
                                    dataType: "JSON",
