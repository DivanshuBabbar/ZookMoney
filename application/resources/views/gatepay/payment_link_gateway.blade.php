        ...
        <div class="row justify-content-md-center">
              <div class="row">
                    <div class="col-md-9 " style="padding-right: 0" id="#sendMoney">
                        ...
                        ?>
                        <script src="{{asset('assets/assets_gatepay/js/jquery-3.3.1.min.js')}}"></script>
                        <!-- <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css"> -->
                        <!-- <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"></script> -->
                        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
                        <link rel="stylesheet" href="{{asset('assets/assets_gatepay/css/custom.css')}}" type="text/css">
                        <div class="card">
                            <h5 class="card-header">{{general_setting('site_name')}}</h5>
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 lw-logo-section">
                                            <div class="lw-logo-container">
                                                <img class="lw-logo" src="{{general_setting('site_logo')}}">
                                            </div>
                                            <h5>Automated Payment Gateway</h5>
                                            <hr class="mb-4">
                                            <h6>Ready to use </h6>
                                            <h6>Instantly approval</h6>
                                            <h6>Many Gateways</h6>
                                                        ...
                                                        <?php
                                                            ...
                                                            $userDetails = [
                                                                'amounts' => [ // at least one currency amount is required
                                                                    'USD'   => \App\Helpers\Money::instance()->value($paymentlink->amount),
                                                                    'INR'   => \App\Helpers\Money::instance()->value($paymentlink->amount),
                                                                    'NGN'   => \App\Helpers\Money::instance()->value($paymentlink->amount),
                                                                    'TRY'   => \App\Helpers\Money::instance()->value($paymentlink->amount),
                                                                    'EUR'   => \App\Helpers\Money::instance()->value($paymentlink->amount),
                                                                    'BRL'   => \App\Helpers\Money::instance()->value($paymentlink->amount)
                                                                ],
                                                                ...
                                                                'item_name'     => $item_name, // required in Paypal gateways
                                                                'item_qty'      => 1,
                                                                'item_id'       => 'ITEM' . uniqid(), // required in Iyzico, Paytm gateways
                                                                'payer_email'   => isset($user->email) ? $user->email:'', // required in instamojo, Iyzico, Stripe gateways
                                                                'payer_name'    => isset($user->name) ? $user->name:'', // required in instamojo, Iyzico gateways
                                                                'payer_mobile'  => isset($user->phonenumber) ? $user->phonenumber:'0',
                                                                'mobile_code'     => '11', // (code) required in pagseguro gateways
                                                                'mobile_number'   => isset($user->phonenumber) ? $user->phonenumber:'0', // (number) required in pagseguro gateways
                                                                'shipping_address' => [
                                                                        ...
                                                                        <label class="form-check-label" for="paymentOption-<?= $key ?>">
                                                                            <fieldset class="lw-fieldset mr-3 mb-3">
                                                                                <legend class="lw-fieldset-legend-font">
                                                                                    ...
                                                                                    <img class="lw-payment-gateway-icon-small" src="{{asset('assets/assets_gatepay/imgs/payment-images/'.$key.'-small.png')}}">
                                                                                </legend>
                                                                                <img class="lw-payment-gateway-icon" src="{{asset('assets/assets_gatepay/imgs/payment-images/'.$key.'-big.jpg')}}">
                                                                            </fieldset>
                                                                        </label>
                                                                    </div> 
                                                                <?php  } } ?>
                ...
                <script type="text/javascript">
                    $(document).ready(function() {
                        ...
                        $('#lwPaymentForm').on('submit', function(e) {
                            ...
                            if (paymentOption == 'paypal' || paymentOption == 'paytm' || paymentOption == 'instamojo' || paymentOption == 'iyzico' || paymentOption == 'authorize-net' || paymentOption == 'bitpay' || paymentOption == 'mercadopago' || paymentOption == 'payumoney' || paymentOption == 'mollie' || paymentOption == 'pagseguro' || paymentOption == 'strowallet') {
                                ...
                                $.ajax({
                                    ...
                                    context: this,
                                    url: '{{url("/payment_gatepay_process_payment")}}', // post data url
                                    dataType: "JSON",
                                    ...
                                    success: function(response) {
                                        ...
                                        if(response.paymentOption == "strowallet") 
                                        {
                                            ...
                                            {
                                                var string = '<div class="alert alert-danger" role="alert">' + response.message + '</div>';
                                                $('#lwValidationMessage').html(string);
                                                //hide loader after ajax request complete
                                                $(".lw-show-till-loading").hide();
                                            }
                                ...
                                var paystackAmount = (parseFloat(amount).toFixed(2)) * 100,
                                ...
                                var razorpayAmount = parseFloat(amount).toFixed(2) * 100,
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(response) {
                                                    if (response.status == "captured") 
                                                    {
                                                        ...
                                                        $('body').html("<form action='" + razorpayCallbackUrl + "' method='get'><input type='hidden' name='response' value='" + JSON.stringify(response) + "'><input type='hidden' name='paymentOption' value='razorpay'></form>");
                                                        $('body form').submit();
                                                    }
                                                    else
                                                    {
                                                        window.location.href="{{route('auto_deposit_failed', app()->getLocale())}}";
                                                    }
                                                }
                                            });
