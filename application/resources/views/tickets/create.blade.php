    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="body"> 
               ...
               <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="{{route('post_new_ticket',app()->getLocale())}}">
                        {!! csrf_field() !!}
                        ...
                        <div class="form-group{{ $errors->has('file') ? ' has-error' : '' }}">
                            <label for="file" class="col-md-4 control-label">{{__('Upload File')}}</label>
