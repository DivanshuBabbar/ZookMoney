       ...
       <div class="col-lg-12 col-md-12">
         <div class="row">
           <div class="col"  id="#sendMoney">
             ...
             <div class="card">
               <div class="header">
                   <h2><strong>{{__('Payout Deposits')}}</strong></h2>
                   
               </div>
               <div class="col-md-2" style="padding-left:21px;">
                  <div class="row">
                     <div class="card">
                        <label style="padding-left:21px;"><b>Balance : {{ Auth::User()->payout_balance}}</b></label>
                     </div>
                  </div>
               </div>
               <div class="col-md-12">
                     ...
                     <div class="col-md-12">
                           <div class="form-group d-flex flex-row justify-content-between gap-3" style="padding-left: 23px;">
                              <div class="dropdown" style="margin-left:5px;">
                                 ...
                                 <a class="dropdown-item" href="{{ route('mydeposits', app()->getLocale()) }}">Deposits</a>
                                 <a class="dropdown-item" href="{{ route('mypayouts', app()->getLocale()) }}">Payout Deposits</a>
                                 </div>
                              </div>
                           </div>
                     </div>
               ...
               <div class="body">
                 <div class="table-responsive">
                   <table class="table align-items-center" id="Depositdatatable">
                      <thead>
                         <tr>
                            <th>User</th>
                            <th>Order Id</th>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Send Deposit Report</h5>
...
@section('js')
   <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
    ...
    <script>
        ...
        const datatable = $('#Depositdatatable').DataTable({
         searchDelay: 500,
         processing: true,
         serverSide: true,
         orderable: true,
         ...
         ajax: {
               url: '{{ route("mypayouts",app()->getLocale()) }}',
               type: 'GET',
               data: function (d) {
