                    ...
                    <ul class="list-group">
                        <li class="list-group-item">
                            <span class="float-left">
                                @isset($val->currency->name){{$val->currency->name}}@endisset :
                            </span>
                            <span class="float-right text-dark font-weight-bold">
                                @isset($val->amount){{formatter_money($val->amount)}}@endisset 
                                @isset($val->currency->code){{$val->currency->code}}@endisset
                            </span>
                        </li>
                    </ul>
                @endforeach
                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        <div class="form-group col-lg-3">
                            ...
                            <input class="form-control" type="text" value="{{ $user->company_name }}" name="company_name" placeholder="company_name">
                        </div>
                        <div class="form-group col-lg-3">
                            <small>State</small>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-lg-6">
                            <p class="text-muted">Make Reseller</p>
                            <input type="checkbox" data-width="100%" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-on="Reseller" data-off="Not Reseller" name="is_reseller" @if($user->is_reseller == 1) checked @endif>
                        </div>
                        
                        <div class="form-group col-lg-6">
                            <p class="text-muted">KYC Verification</p>
                            <input type="checkbox" data-width="100%" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-on="1" data-off="0" name="kyc" @if($user->kyc) checked @endif>
                        </div>
                        <div class="form-group col-lg-6">
                            <p class="text-muted">User type</p>
                            <input type="checkbox" data-width="100%" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-on="Online" data-off="Offline" name="user_type" @if($user->user_type) checked @endif>
                        </div>
