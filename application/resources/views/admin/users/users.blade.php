                ...
                <table class="table align-items-center table-light">
                    ...
                    <tbody class="list">
                        ...
                        <tr>
                            ...
                            <td>
                                @if($user->kyc == 2)
                                <a href="{{ route('admin.users.kyc', $user->id) }}" class="btn btn-warning">View KYC Docs</a>
                                @elseif($user->kyc == 1)
                                <a href="{{ route('admin.users.kyc', $user->id) }}" class="btn btn-success">View KYC Docs</a>
                                @endif
                                <a href="{{ route('admin.users.impersonate', $user->id) }}"  target="_blank" class="btn btn-rounded btn-info text-white">
                                    Impersonate User
                                </a>
