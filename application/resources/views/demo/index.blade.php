        ...
        <div class="container" style="margin-top: 50px">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <h4 style="margin-bottom: 20px">Regular User</h4>                    
                    ...
                    <div class="demo-links">
                        <a href="{{route('demouser', app()->getLocale())}}" target="_blank" class="btn btn-fill btn-large btn-margin-right">Demo Link</a>
                    </div>
                </div>
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <h4 style="margin-bottom: 20px">Admin Dashboard</h4>                    
                    {{-- <div class="demo-img"><a href="https://www.youtube.com/watch?v=eLdPHnglJVQ" target="_blank" ><img alt=""  src="{{asset('assets/images/thumb2.jpg')}}" class="img-responsive"></a></div> --}}
                    <div class="demo-links">
                        <a href="https://www.youtube.com/watch?v=eLdPHnglJVQ" target="_blank" class="btn btn-fill btn-large btn-margin-right">Video Link</a>
                    </div>
                </div>
            </div>
        </div>
