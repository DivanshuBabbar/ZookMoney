        ...
        <div class="container">
            <div class="login-form-title text-center">
                ...
                <figure class="login-page-logo">
                    <img src="{{asset('assets/frontend/images/zookmoney.png')}}" alt="">
                </figure>
                </a>
                ...
                <div class="login-card">
                    <form class="form" method="POST" action="{{ route('register', app()->getLocale()) }}">
                       ...
                       <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-primary mb-0" disabled>@lang('Sign Up') <i class="las la-sign-in-alt"></i></button>
                    </form>
                </div>
                <div class="join-now-outer text-center">
                <a class="mb-0" href="{{url('/')}}/{{app()->getLocale()}}/login">Already have an account?</a>
                </div>
            </div>   
        </div>
...
<script>
    ...
    $(function(){
        $('#confirm_user').css('background', 'transparent');
        $('#confirm_user').css('color', 'coral');
        $('#confirm_merchant').css('background', 'coral');
        $('#confirm_merchant').css('color', 'white');
        $('#is_merchant').val('1');
        $('#is_user').val('0');
       
    });
    $('#confirm_merchant').click(function() {
        $('#confirm_user').css('background', 'transparent');
        $('#confirm_user').css('color', 'coral');
        $('#confirm_merchant').css('background', 'coral');
        $('#confirm_merchant').css('color', 'white');
    ...
    $('#confirm_user').click(function() {
        $('#confirm_merchant').css('background', 'transparent');
        $('#confirm_merchant').css('color', 'coral');
        $('#confirm_user').css('background', 'coral');
        $('#confirm_user').css('color', 'white');
        $('#is_user').val('1');
        $('#is_merchant').val('0');
    });
