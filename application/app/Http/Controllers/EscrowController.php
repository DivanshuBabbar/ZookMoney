...
class EscrowController extends Controller
{
    ...
    public function store(Request $request, $lang){
        ...
        //$receive_fee = ((general_setting('mt_percentage_fee')/100)* (double)$request->amount) + general_setting('mt_fixed_fee') ;
    ...
    public function release(Request $request, $lang){
        ...
        if ($escrow->escrow_transaction_status == 'completed' or $escrow->escrow_transaction_status == 'refunded') {
    ...
    public function refund(Request $request, $lang){
        ...
        $escrow->escrow_transaction_status = 'refunded';
        $escrow->save();
