...
class Deposit extends Model
{
    ...
    protected $fillable = ['user_id', 'transaction_state_id', 'transaction_receipt', 'transaction_receipt_ref_no', 'deposit_method_id', 'gross', 'fee', 'net', 'json_data', 'wallet_id', 'currency_id', 'currency_symbol','message','transfer_method_id', 'unique_transaction_id', 'qr_service_payload', 'request_id','type'];
