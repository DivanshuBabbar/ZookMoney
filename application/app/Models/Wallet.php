...
{
	protected $fillable = ['user_id', 'amount', 'currency_id', 'is_crypto', 'crypto', 'fiat', 'transfer_method_id', 'accont_identifier_mechanism_value'];
	...
	public function exchangeRates(){
		return $this->hasMany(CurrencyExchangeRate::class, 'first_currency_id', 'currency_id');
	}
